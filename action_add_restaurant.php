    ...
    if (sizeof($errors) != 0) {
      ...
      try {
        if (trim($_POST['image_url']) != '') {
          addRestaurant($dbh, $_POST['name'], $_POST['description'], $_POST['image_url'], $_POST['address']);
          $array = getRestaurantId($dbh, $_POST['name'], $_POST['description'], $_POST['image_url'], $_POST['address']);
        }
  	    ...
  	    addRestaurant($dbh, $_POST['name'], $_POST['description'], $target_dir, $_POST['address']);
  	    $array = getRestaurantId($dbh, $_POST['name'], $_POST['description'], $target_dir, $_POST['address']);
          }
         }
         else
