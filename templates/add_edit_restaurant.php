<form class="modal-content animate" action="action_add_edit_restaurant.php" method="post" enctype="multipart/form-data">
    ...
    <div class="container">
        ...
        <input type="text" placeholder="Restaurant name" name="name" <?php if ($restaurant != NULL) ?> value=<?=$restaurant['name']?> />
        <label for="description"><b>Description</></label>
        <input type="text" placeholder="Description" name="description" <?php if ($restaurant != NULL) ?> value=<?=$restaurant['description']?> />
        <label for="image_url"><b>Image URL</b></label>
        <input type="url" placeholder="Image URL" name="image_url" <?php if ($restaurant != NULL) ?> value=<?=$restaurant['image_dir']?> />
        <label for="image_file"><b>Image file</b></label>
        <input type="file" name="image_file" />
        <label for="address"><b>Address</b></label>
        <input type="text" placeholder="Address" name="address" <?php if ($restaurant != NULL) ?> value=<?=$restaurant['address']?> />
